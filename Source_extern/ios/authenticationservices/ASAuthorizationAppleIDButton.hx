...
import ios.authenticationservices.ASAuthorizationAppleIDButton;
import ios.authenticationservices.ASAuthorizationAppleIDButtonType;
import ios.authenticationservices.ASAuthorizationAppleIDButtonStyle;
...
extern class ASAuthorizationAppleIDButton extends UIControl{

	@:native("alloc")
	overload public static function alloc():ASAuthorizationAppleIDButton;

	@:native("autorelease")
	overload public static function autorelease():ASAuthorizationAppleIDButton;

	@:native("buttonWithType:style")
	overload public static function buttonWithTypeStyle(type:ASAuthorizationAppleIDButtonType, style:ASAuthorizationAppleIDButtonStyle):ASAuthorizationAppleIDButton;

	@:native("initWithAuthorizationButtonType:authorizationButtonStyle")
	overload public function initWithAuthorizationButtonTypeAuthorizationButtonStyle(type:ASAuthorizationAppleIDButtonType, authorizationButtonStyle:ASAuthorizationAppleIDButtonStyle):ASAuthorizationAppleIDButton;
	...
	overload public function initWithFrame(frame:CGRect):ASAuthorizationAppleIDButton;

	@:native("initWithCoder")
	overload public function initWithCoder(coder:NSCoder):ASAuthorizationAppleIDButton;

	@:native("initWithFrame:primaryAction")
	overload public function initWithFramePrimaryAction(frame:CGRect, primaryAction:UIAction):ASAuthorizationAppleIDButton;
