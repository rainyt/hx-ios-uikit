...
//implements cpp.objc.Protocol<ObjectType>
{
	...
	@:native("setWithSet")
	overload public static function setWithSet(set:NSSet):NSMutableSet;

	@:native("setWithArray")
	overload public static function setWithArray(array:NSArray):NSMutableSet;

	@:native("initWithObjects")
	overload public function initWithObjects(firstObj:Dynamic):NSMutableSet;

	@:native("initWithSet")
	overload public function initWithSet(set:NSSet):NSMutableSet;

	@:native("initWithSet:copyItems")
	overload public function initWithSetCopyItems(set:NSSet, copyItems:Bool):NSMutableSet;

	@:native("initWithArray")
	overload public function initWithArray(array:NSArray):NSMutableSet;
