...
extern class CADisplayLink {
	@:native("addToRunLoop:forMode") public function addToRunLoop_forMode(runloop:Dynamic, mode:NSString):Void;
	...
	@:native("removeFromRunLoop:forMode") public function removeFromRunLoop_forMode(runloop:Dynamic, mode:NSString):Void;
