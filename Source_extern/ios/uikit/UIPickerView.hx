...
//implements cpp.objc.Protocol<NSCoding>
{
	...
	overload public function viewForRowForComponent(row:Int, forComponent:Int):UIView;
	...
	overload public function selectRowInComponentAnimated(row:Int, inComponent:Int, animated:Bool):Void;
...
;
	...
	overload public function initWithFrame(frame:CGRect):UIPickerView;

	@:native("initWithCoder")
	overload public function initWithCoder(coder:NSCoder):UIPickerView;
