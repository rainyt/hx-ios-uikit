...
extern class UIAlertController extends UIViewController{
	...
	@:native("init")
	overload public function init():UIAlertController;

	@:native("autorelease")
	overload public static function autorelease():UIAlertController;

	@:native("alertControllerWithTitle:message:preferredStyle")
	overload public static function alertControllerWithTitleMessagePreferredStyle(title:NSString, message:NSString, preferredStyle:UIAlertControllerStyle):UIAlertController;
	...
	overload public function initWithNibNameBundle(nibNameOrNil:NSString, bundle:NSBundle):UIAlertController;
