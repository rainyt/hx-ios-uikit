...
extern interface UIPageViewControllerDelegate{
	...
	overload public function pageViewController_willTransitionToViewControllers(pageViewController:UIPageViewController, willTransitionToViewControllers:NSArray):Void;

	@:native("pageViewController:didFinishAnimating:previousViewControllers:transitionCompleted")
	overload public function pageViewController_didFinishAnimating_previousViewControllers_transitionCompleted(pageViewController:UIPageViewController, didFinishAnimating:Bool, previousViewControllers:NSArray, transitionCompleted:Bool):Void;
