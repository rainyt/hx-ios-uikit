...
extern class UISearchBar{
	...
	overload extern inline public function initWithFrame(frame:CGRect):UISearchBar;

	@:native("initWithCoder")
	overload extern inline public function initWithCoder(NSCoder:null):UISearchBar;
	...
	@:native("setShowsCancelButton")
	overload extern inline public function setShowsCancelButton(showsCancelButton:BOOL):void;
	...
	@:native("setShowsScopeBar")
	overload extern inline public function setShowsScopeBar(show:BOOL):void;
	...
	overload extern inline public function setSearchFieldBackgroundImage(nullable:null):void;

	@:native("searchFieldBackgroundImageForState")
	overload extern inline public function searchFieldBackgroundImageForState(state:UIControlState):nullable UIImage *;

	@:native("setImage")
	overload extern inline public function setImage(nullable:null):void;

	@:native("imageForSearchBarIcon")
	overload extern inline public function imageForSearchBarIcon(icon:UISearchBarIcon):nullable UIImage *;

	@:native("setScopeBarButtonBackgroundImage")
	overload extern inline public function setScopeBarButtonBackgroundImage(nullable:null):void;

	@:native("scopeBarButtonBackgroundImageForState")
	overload extern inline public function scopeBarButtonBackgroundImageForState(state:UIControlState):nullable UIImage *;

	@:native("setScopeBarButtonDividerImage")
	overload extern inline public function setScopeBarButtonDividerImage(nullable:null):void;

	@:native("scopeBarButtonDividerImageForLeftSegmentState")
	overload extern inline public function scopeBarButtonDividerImageForLeftSegmentState(leftState:UIControlState):nullable UIImage *;

	@:native("setScopeBarButtonTitleTextAttributes")
	overload extern inline public function setScopeBarButtonTitleTextAttributes(nullable:null):void;

	@:native("scopeBarButtonTitleTextAttributesForState")
	overload extern inline public function scopeBarButtonTitleTextAttributesForState(state:UIControlState):nullable NSDictionary<NSAttributedStringKey, id> *;
	...
	@:native("setPositionAdjustment")
	overload extern inline public function setPositionAdjustment(adjustment:UIOffset):void;

	@:native("positionAdjustmentForSearchBarIcon")
	overload extern inline public function positionAdjustmentForSearchBarIcon(icon:UISearchBarIcon):UIOffset;
	...
	@:native("searchBar")
	overload extern inline public function searchBar(UISearchBar:null):void;

	@:native("searchBar")
	overload extern inline public function searchBar(UISearchBar:null):BOOL;
	...
	overload extern inline public function searchBarBookmarkButtonClicked(UISearchBar:null):void;

	@:native("searchBarCancelButtonClicked")
	overload extern inline public function searchBarCancelButtonClicked(UISearchBar:null):void;

	@:native("searchBarResultsListButtonClicked")
	overload extern inline public function searchBarResultsListButtonClicked(UISearchBar:null):void;
