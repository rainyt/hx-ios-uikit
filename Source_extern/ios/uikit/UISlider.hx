...
//implements cpp.objc.Protocol<NSCoding>
{
	...
	overload public function setValueAnimated(value:Dynamic, animated:Bool):Void;

	@:native("setThumbImage:forState")
	overload public function setThumbImageForState(image:UIImage, forState:UIControlState):Void;

	@:native("setMinimumTrackImage:forState")
	overload public function setMinimumTrackImageForState(image:UIImage, forState:UIControlState):Void;

	@:native("setMaximumTrackImage:forState")
	overload public function setMaximumTrackImageForState(image:UIImage, forState:UIControlState):Void;
...
;
	...
	overload public function initWithFramePrimaryAction(frame:CGRect, primaryAction:UIAction):UISlider;
