...
extern abstract UIApplicationShortcutIconType(Int) from Int to Int {
	...
	@:native("UIApplicationShortcutIconTypeCompose")
	var UIApplicationShortcutIconTypeCompose;

	@:native("UIApplicationShortcutIconTypePlay")
	var UIApplicationShortcutIconTypePlay;

	@:native("UIApplicationShortcutIconTypePause")
	var UIApplicationShortcutIconTypePause;

	@:native("UIApplicationShortcutIconTypeAdd")
	var UIApplicationShortcutIconTypeAdd;

	@:native("UIApplicationShortcutIconTypeLocation")
	var UIApplicationShortcutIconTypeLocation;

	@:native("UIApplicationShortcutIconTypeSearch")
	var UIApplicationShortcutIconTypeSearch;
