...
extern class UIActionSheet extends UIView{
	...
	overload public function showFromBarButtonItemAnimated(item:UIBarButtonItem, animated:Bool):Void;

	@:native("showFromRect:inView:animated")
	overload public function showFromRectInViewAnimated(rect:CGRect, inView:UIView, animated:Bool):Void;

	@:native("showInView")
	overload public function showInView(view:UIView):Void;

	@:native("dismissWithClickedButtonIndex:animated")
	overload public function dismissWithClickedButtonIndexAnimated(buttonIndex:Int, animated:Bool):Void;
	...
	overload public function initWithFrame(frame:CGRect):UIActionSheet;

	@:native("initWithCoder")
	overload public function initWithCoder(coder:NSCoder):UIActionSheet;
