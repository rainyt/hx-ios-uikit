...
extern class UITraitCollection{
	...
	overload extern inline public function containsTraitsInCollection(nullable:null):BOOL;
	...
	overload extern inline public function traitCollectionDidChange(nullable:null):void;

	@:native("API_UNAVAILABLE(watchos)")
	public var API_UNAVAILABLE(watchos):tvos(13.0));

	@:native("performAsCurrentTraitCollection")
	overload extern inline public function performAsCurrentTraitCollection(void:null):void;

	@:native("hasDifferentColorAppearanceComparedToTraitCollection")
	overload extern inline public function hasDifferentColorAppearanceComparedToTraitCollection(nullable:null):BOOL;
