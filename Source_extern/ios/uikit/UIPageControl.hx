...
extern class UIPageControl extends UIControl{
	...
	overload public function setIndicatorImageForPage(image:UIImage, forPage:Int):Void;
	...
	overload public function initWithFramePrimaryAction(frame:CGRect, primaryAction:UIAction):UIPageControl;
