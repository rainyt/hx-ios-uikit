...
extern class UIRefreshControl extends UIControl{
	...
	/* The designated initializer  * This initializes a UIRefreshControl with a default height and width.  * Once assigned to a UITableViewController, the frame of the control is managed automatically.  * When a user has pulled-to-refresh, the UIRefreshControl fires its UIControlEventValueChanged event.  * */
	@:native("init")
	...
	overload public function initWithFrame(frame:CGRect):UIRefreshControl;

	@:native("initWithCoder")
	overload public function initWithCoder(coder:NSCoder):UIRefreshControl;

	@:native("initWithFrame:primaryAction")
	overload public function initWithFramePrimaryAction(frame:CGRect, primaryAction:UIAction):UIRefreshControl;
