...
extern class UISplitViewController extends UIViewController{
	...
	overload public function initWithNibNameBundle(nibNameOrNil:NSString, bundle:NSBundle):UISplitViewController;
	...
	overload public function setViewControllerForColumn(vc:UIViewController, forColumn:UISplitViewControllerColumn):Void;
