...
extern class UIImageView extends UIView{
	...
	overload public function initWithImageHighlightedImage(image:UIImage, highlightedImage:UIImage):UIImageView;
	...
	public var animationImages:NSArray;

	@:native("highlightedAnimationImages")
	public var highlightedAnimationImages:NSArray;
	...
	overload public function initWithFrame(frame:CGRect):UIImageView;

	@:native("initWithCoder")
	overload public function initWithCoder(coder:NSCoder):UIImageView;
