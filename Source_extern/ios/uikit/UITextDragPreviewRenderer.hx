...
extern class UITextDragPreviewRenderer{
	...
	overload public function initWithLayoutManagerRange(layoutManager:NSLayoutManager, range:Dynamic):UITextDragPreviewRenderer;

	@:native("initWithLayoutManager:range:unifyRects")
	overload public function initWithLayoutManagerRangeUnifyRects(layoutManager:NSLayoutManager, range:Dynamic, unifyRects:Bool):UITextDragPreviewRenderer;
	...
	overload public function adjustFirstLineRectBodyRectLastLineRectTextOrigin(firstLineRect:Dynamic, bodyRect:Dynamic, lastLineRect:Dynamic, textOrigin:CGPoint):Void;
