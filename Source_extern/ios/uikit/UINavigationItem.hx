...
//implements cpp.objc.Protocol<NSCoding>
{
	...
	public var leftBarButtonItems:NSArray;

	@:native("rightBarButtonItems")
	public var rightBarButtonItems:NSArray;

	@:native("setLeftBarButtonItems:animated")
	overload public function setLeftBarButtonItemsAnimated(items:NSArray, animated:Bool):Void;

	@:native("setRightBarButtonItems:animated")
	overload public function setRightBarButtonItemsAnimated(items:NSArray, animated:Bool):Void;
