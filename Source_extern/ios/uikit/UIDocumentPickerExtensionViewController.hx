...
extern class UIDocumentPickerExtensionViewController extends UIViewController{
	...
	overload public function initWithNibNameBundle(nibNameOrNil:NSString, bundle:NSBundle):UIDocumentPickerExtensionViewController;

	@:native("initWithCoder")
	overload public function initWithCoder(coder:NSCoder):UIDocumentPickerExtensionViewController;
