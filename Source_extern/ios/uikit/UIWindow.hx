...
extern class UIWindow extends UIView{
	...
	overload public function convertPointToWindow(point:CGPoint, toWindow:UIWindow):CGPoint;

	@:native("convertPoint:fromWindow")
	overload public function convertPointFromWindow(point:CGPoint, fromWindow:UIWindow):CGPoint;

	@:native("convertRect:toWindow")
	overload public function convertRectToWindow(rect:CGRect, toWindow:UIWindow):CGRect;

	@:native("convertRect:fromWindow")
	overload public function convertRectFromWindow(rect:CGRect, fromWindow:UIWindow):CGRect;
	...
	overload public function initWithFrame(frame:CGRect):UIWindow;

	@:native("initWithCoder")
	overload public function initWithCoder(coder:NSCoder):UIWindow;
