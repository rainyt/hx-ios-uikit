...
extern class UILabel extends UIView
{
	...
	overload public function textRectForBoundsLimitedToNumberOfLines(bounds:CGRect, limitedToNumberOfLines:Int):CGRect;
...
;
	...
	overload public function initWithFrame(frame:CGRect):UILabel;

	@:native("initWithCoder")
	overload public function initWithCoder(coder:NSCoder):UILabel;
