...
extern class UINavigationBar extends UIView
{
	...
	overload public function pushNavigationItemAnimated(item:UINavigationItem, animated:Bool):Void;
	...
	overload public function setBackgroundImageForBarMetrics(backgroundImage:UIImage, forBarMetrics:UIBarMetrics):Void;
	...
	overload public function setTitleVerticalPositionAdjustmentForBarMetrics(adjustment:Float, forBarMetrics:UIBarMetrics):Void;
	...
	/*  Fallback Behavior:  1) Appearance objects are used in whole – that is, all values will be sourced entirely from an instance of UINavigationBarAppearance defined by one of these named properties (standardAppearance, compactAppearance, scrollEdgeAppearance) on either UINavigationBar (self) or UINavigationItem (self.topItem).  2) The navigation bar will always attempt to use the most relevant appearance instances first, before falling back to less relevant ones. The fallback logic is:      AtScrollEdge: self.topItem.scrollEdgeAppearance => self.scrollEdgeAppearance => self.topItem.standardAppearance => self.standardAppearance      CompactSize: self.topItem.compactAppearance => self.compactAppearance => self.topItem.standardAppearance => self.standardAppearance      NormalSize: self.topItem.standardAppearance => self.standardAppearance  */
...
;
	...
	overload public function initWithFrame(frame:CGRect):UINavigationBar;

	@:native("initWithCoder")
	overload public function initWithCoder(coder:NSCoder):UINavigationBar;
