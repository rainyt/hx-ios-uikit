...
extern class UICollectionViewCell extends UICollectionReusableView{
	...
	overload public function willTransitionFromLayoutToLayout(oldLayout:UICollectionViewLayout, toLayout:UICollectionViewLayout):Void;

	@:native("didTransitionFromLayout:toLayout")
	overload public function didTransitionFromLayoutToLayout(oldLayout:UICollectionViewLayout, toLayout:UICollectionViewLayout):Void;
	...
	overload public function initWithFrame(frame:CGRect):UICollectionViewCell;

	@:native("initWithCoder")
	overload public function initWithCoder(coder:NSCoder):UICollectionViewCell;
