...
extern interface UIApplicationDelegate{
	...
	overload public function application_willFinishLaunchingWithOptions(application:UIApplication, willFinishLaunchingWithOptions:NSDictionary):Bool;

	@:native("application:didFinishLaunchingWithOptions")
	overload public function application_didFinishLaunchingWithOptions(application:UIApplication, didFinishLaunchingWithOptions:NSDictionary):Bool;
	...
	overload public function application_openURL_options(app:UIApplication, openURL:Dynamic, options:NSDictionary):Bool;
