...
extern class UIImage{
	...
	overload extern inline public function initWithCIImage(CIImage:null):UIImage;
	...
	overload extern inline public function resizableImageWithCapInsets(capInsets:UIEdgeInsets):UIImage *;
	...
	overload extern inline public function imageByApplyingSymbolConfiguration(UIImageSymbolConfiguration:null):nullable UIImage *;

	@:native("imageWithTintColor")
	overload extern inline public function imageWithTintColor(UIColor:null):UIImage *;
	...
	@:native("stretchableImageWithLeftCapWidth")
	overload extern inline public function stretchableImageWithLeftCapWidth(leftCapWidth:NSInteger):UIImage *;
	...
	overload extern inline public function initWithImage(UIImage:null):UIImage;
