...
extern class UIStepper extends UIControl{
	...
	overload public function setDividerImageForLeftSegmentStateRightSegmentState(image:UIImage, forLeftSegmentState:UIControlState, rightSegmentState:UIControlState):Void;

	@:native("dividerImageForLeftSegmentState:rightSegmentState")
	overload public function dividerImageForLeftSegmentStateRightSegmentState(state:UIControlState, rightSegmentState:UIControlState):UIImage;

	@:native("setIncrementImage:forState")
	overload public function setIncrementImageForState(image:UIImage, forState:UIControlState):Void;
	...
	overload public function setDecrementImageForState(image:UIImage, forState:UIControlState):Void;

	@:native("decrementImageForState")
	overload public function decrementImageForState(state:UIControlState):UIImage;

	@:native("initWithFrame")
	overload public function initWithFrame(frame:CGRect):UIStepper;

	@:native("initWithCoder")
	overload public function initWithCoder(coder:NSCoder):UIStepper;

	@:native("initWithFrame:primaryAction")
	overload public function initWithFramePrimaryAction(frame:CGRect, primaryAction:UIAction):UIStepper;
