...
extern class UIAccessibilityAdditions{
	...
	@:native("pickerView")
	overload extern inline public function pickerView(UIPickerView:null):NSArray<NSString *> *;
	...
	@:native("pickerView")
	overload extern inline public function pickerView(UIPickerView:null):NSArray<NSAttributedString *> *;
	...
	overload extern inline public function accessibilityAttributedScrollStatusForScrollView(UIScrollView:null):nullable NSAttributedString *;
