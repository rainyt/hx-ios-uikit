...
extern class UIBarButtonItem{
	...
	overload public function initWithTitle_style_target_action(title:Dynamic, style:UIBarButtonItemStyle, target:Dynamic, action:String):UIBarButtonItem;
	...
	overload public function initWithTitle_menu(title:Dynamic, menu:UIMenu):UIBarButtonItem;
