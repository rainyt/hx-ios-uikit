...
extern class UIBarButtonItem{
	...
	overload public function initWithTitle_style_target_action(title:Dynamic, style:Dynamic, target:Dynamic, action:String):UIBarButtonItem;
	...
	overload public function initWithTitle_menu(title:Dynamic, menu:Dynamic):UIBarButtonItem;
