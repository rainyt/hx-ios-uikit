...
extern class UIScrollView{
	...
	overload extern inline public function setContentOffset(contentOffset:CGPoint):void;

	@:native("scrollRectToVisible")
	overload extern inline public function scrollRectToVisible(rect:CGRect):void;
	...
	overload extern inline public function touchesShouldBegin(NSSet<UITouch:null):BOOL;
	...
	@:native("setZoomScale")
	overload extern inline public function setZoomScale(scale:CGFloat):void;

	@:native("zoomToRect")
	overload extern inline public function zoomToRect(rect:CGRect):void;
	...
	overload extern inline public function scrollViewDidZoom(UIScrollView:null):void;
	...
	overload extern inline public function scrollViewWillEndDragging(UIScrollView:null):void;

	@:native("scrollViewDidEndDragging")
	overload extern inline public function scrollViewDidEndDragging(UIScrollView:null):void;
	...
	overload extern inline public function scrollViewWillBeginZooming(UIScrollView:null):void;

	@:native("scrollViewDidEndZooming")
	overload extern inline public function scrollViewDidEndZooming(UIScrollView:null):void;
	...
	overload extern inline public function scrollViewDidChangeAdjustedContentInset(UIScrollView:null):void;
