...
extern class UIViewControllerTransitionCoordinator{
	...
	overload extern inline public function animateAlongsideTransition(void:null):BOOL;

	@:native("animateAlongsideTransitionInView")
	overload extern inline public function animateAlongsideTransitionInView(nullable:null):BOOL;

	@:native("notifyWhenInteractionEndsUsingBlock")
	overload extern inline public function notifyWhenInteractionEndsUsingBlock(:null):void;

	@:native("notifyWhenInteractionChangesUsingBlock")
	overload extern inline public function notifyWhenInteractionChangesUsingBlock(:null):void;
