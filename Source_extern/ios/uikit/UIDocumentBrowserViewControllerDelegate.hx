...
extern interface UIDocumentBrowserViewControllerDelegate{
	...
	overload public function documentBrowser_didPickDocumentsAtURLs(controller:UIDocumentBrowserViewController, didPickDocumentsAtURLs:NSArray):Void;
	...
	overload public function documentBrowser_applicationActivitiesForDocumentURLs(controller:UIDocumentBrowserViewController, applicationActivitiesForDocumentURLs:NSArray):NSArray;
