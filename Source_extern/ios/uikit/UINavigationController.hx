...
extern class UINavigationController{
	...
	overload extern inline public function initWithNavigationBarClass(nullable:null):UINavigationController;
	...
	overload extern inline public function initWithNibName(nullable:null):UINavigationController;

	@:native("initWithCoder")
	overload extern inline public function initWithCoder(NSCoder:null):UINavigationController;

	@:native("pushViewController")
	overload extern inline public function pushViewController(UIViewController:null):void;
	...
	overload extern inline public function popToViewController(UIViewController:null):nullable NSArray<__kindof UIViewController *> *;
	...
	overload extern inline public function setViewControllers(NSArray<UIViewController:null):void;

	@:native("navigationBarHidden")
	public var navigationBarHidden:BOOL;

	@:native("setNavigationBarHidden")
	overload extern inline public function setNavigationBarHidden(hidden:BOOL):void;
	...
	@:native("setToolbarHidden")
	overload extern inline public function setToolbarHidden(hidden:BOOL):void;
	...
	overload extern inline public function navigationController(UINavigationController:null):void;

	@:native("navigationController")
	overload extern inline public function navigationController(UINavigationController:null):void;

	@:native("navigationControllerSupportedInterfaceOrientations")
	overload extern inline public function navigationControllerSupportedInterfaceOrientations(UINavigationController:null):UIInterfaceOrientationMask;

	@:native("navigationControllerPreferredInterfaceOrientationForPresentation")
	overload extern inline public function navigationControllerPreferredInterfaceOrientationForPresentation(UINavigationController:null):UIInterfaceOrientation;
	...
	overload extern inline public function setToolbarItems(nullable:null):void;
