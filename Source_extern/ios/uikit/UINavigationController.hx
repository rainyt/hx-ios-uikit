...
extern class UINavigationController extends UIViewController{
	...
	overload public function initWithNavigationBarClassToolbarClass(navigationBarClass:Dynamic, toolbarClass:Dynamic):UINavigationController;
	...
	overload public function initWithNibNameBundle(nibNameOrNil:NSString, bundle:NSBundle):UINavigationController;
