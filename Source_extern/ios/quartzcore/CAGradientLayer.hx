...
extern class CAGradientLayer extends CALayer{
	...
	@:native("init")
	overload public function init():CAGradientLayer;
	...
	/* The kind of gradient that will be drawn. Currently, the only allowed  * values are `axial' (the default value), `radial', and `conic'. */
	@:native("type")
