...
import ios.quartzcore.CAScrollLayer;
...
extern class CAScrollLayer extends CALayer{
	...
	@:native("alloc")
	overload public static function alloc():CAScrollLayer;

	@:native("init")
	overload public function init():CAScrollLayer;

	@:native("autorelease")
	overload public static function autorelease():CAScrollLayer;

	/* Changes the origin of the layer to point 'p'. */
	@:native("scrollToPoint")
	overload public function scrollToPoint(p:CGPoint):Void;

	/* Scroll the contents of the layer to ensure that rect 'r' is visible. */
	@:native("scrollToRect")
	overload public function scrollToRect(r:CGRect):Void;

	/* Defines the axes in which the layer may be scrolled. Possible values  * are `none', `vertically', `horizontally' or `both' (the default). */
	@:native("scrollMode")
	public var scrollMode:NSString;
	...
	@:native("layer")
	overload public static function layer():CAScrollLayer;
	...
	overload public function initWithLayer(layer:Dynamic):CAScrollLayer;
