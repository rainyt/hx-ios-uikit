...
extern class CATextLayer extends CALayer{
	...
	@:native("init")
	overload public function init():CATextLayer;

	@:native("autorelease")
	overload public static function autorelease():CATextLayer;

	/* The text to be rendered, should be either an NSString or an  * NSAttributedString. Defaults to nil. */
	@:native("string")
	public var string:Dynamic;

	/* The font to use, currently may be either a CTFontRef (toll-free  * bridged from UIFont), a CGFontRef, or a string naming the font.  * Defaults to the Helvetica font. Only used when the `string' property  * is not an NSAttributedString. */
	@:native("font")
	public var font:Dynamic;

	/* The font size. Defaults to 36. Only used when the `string' property  * is not an NSAttributedString. Animatable (Mac OS X 10.6 and later.) */
	@:native("fontSize")
	public var fontSize:Float;

	/* The color object used to draw the text. Defaults to opaque white.  * Only used when the `string' property is not an NSAttributedString.  * Animatable (Mac OS X 10.6 and later.) */
	@:native("foregroundColor")
	public var foregroundColor:Dynamic;

	/* When true the string is wrapped to fit within the layer bounds.  * Defaults to NO.*/
	@:native("wrapped")
	public var wrapped:Bool;

	/* Describes how the string is truncated to fit within the layer  * bounds. The possible options are `none', `start', `middle' and  * `end'. Defaults to `none'. */
	@:native("truncationMode")
	public var truncationMode:NSString;

	/* Describes how individual lines of text are aligned within the layer  * bounds. The possible options are `natural', `left', `right',  * `center' and `justified'. Defaults to `natural'. */
	@:native("alignmentMode")
	public var alignmentMode:NSString;

	/* Sets allowsFontSubpixelQuantization parameter of CGContextRef  * passed to the -drawInContext: method. Defaults to NO. */
