...
import ios.quartzcore.CATiledLayer;
 ...
 * regular CALayer. */
extern class CATiledLayer extends CALayer{

	@:native("alloc")
	overload public static function alloc():CATiledLayer;

	@:native("init")
	overload public function init():CATiledLayer;

	@:native("autorelease")
	overload public static function autorelease():CATiledLayer;

	/* The time in seconds that newly added images take to "fade-in" to the  * rendered representation of the tiled layer. The default implementation  * returns 0.25 seconds. */
	@:native("fadeDuration")
	overload public static function fadeDuration():Dynamic;
	...
	@:native("levelsOfDetail")
	public var levelsOfDetail:Dynamic;

	/* The number of magnified levels of detail for this layer. Defaults to  * zero. Each previous level of detail is twice the resolution of the  * later. E.g. specifying 'levelsOfDetailBias' of two means that the  * layer devotes two of its specified levels of detail to  * magnification, i.e. 2x and 4x. */
	@:native("levelsOfDetailBias")
	public var levelsOfDetailBias:Dynamic;

	/* The maximum size of each tile used to create the layer's content.  * Defaults to (256, 256). Note that there is a maximum tile size, and  * requests for tiles larger than that limit will cause a suitable  * value to be substituted. */
	@:native("tileSize")
	...
	@:native("layer")
	overload public static function layer():CATiledLayer;
	...
	overload public function initWithLayer(layer:Dynamic):CATiledLayer;
