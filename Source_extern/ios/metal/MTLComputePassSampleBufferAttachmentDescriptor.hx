...
@:objc
@:native("MTLComputePassSampleBufferAttachmentDescriptor")
@:include("Metal/Metal.h")
extern class MTLComputePassSampleBufferAttachmentDescriptor
//implements cpp.objc.Protocol<NSCopying>
{

	@:native("alloc")
	overload public static function alloc():MTLComputePassSampleBufferAttachmentDescriptor;

	@:native("autorelease")
	overload public static function autorelease():MTLComputePassSampleBufferAttachmentDescriptor;
