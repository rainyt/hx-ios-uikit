...
import ios.metal.MTLVisibleFunctionTable;
...
@:objc
@:native("MTLVisibleFunctionTable")
...
//implements cpp.objc.Protocol<MTLResource>
{
	...
	@:native("alloc")
	overload public static function alloc():MTLVisibleFunctionTable;

	@:native("autorelease")
	overload public static function autorelease():MTLVisibleFunctionTable;
