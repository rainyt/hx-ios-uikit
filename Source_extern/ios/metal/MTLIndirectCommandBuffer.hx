...
import ios.metal.MTLIndirectCommandBuffer;
...
@:objc
@:native("MTLIndirectCommandBuffer")
@:include("Metal/Metal.h")
extern interface MTLIndirectCommandBuffer
//implements cpp.objc.Protocol<MTLResource>
{

	@:native("alloc")
	overload public static function alloc():MTLIndirectCommandBuffer;

	@:native("autorelease")
	overload public static function autorelease():MTLIndirectCommandBuffer;
	...
	@:native("resetWithRange")
	overload public function resetWithRange(range:Dynamic):Void;

	@:native("indirectRenderCommandAtIndex")
	overload public function indirectRenderCommandAtIndex(commandIndex:Int):Dynamic;

	@:native("indirectComputeCommandAtIndex")
	overload public function indirectComputeCommandAtIndex(commandIndex:Int):Dynamic;
